...
# -*- coding: utf-8 -*-
'''
현대경제연구원 보고서 Scikit-learn 모듈을 이용한 베이즈 분류 적용
'''

"""
classify_news_bin_nb.py

보고서를 MagazineID의 7가지 부류로 분류한다.
...
def main():
    ...
    nb = MultinomialNB()
    nb.fit(train_doc_term_mat, train_labels)
    pred_labels = nb.predict(test_doc_term_mat)
